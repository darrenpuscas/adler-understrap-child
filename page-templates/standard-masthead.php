<?php
/**
 * Template Name: Standard with Masthead
 *
 * Template for a standard page with an opening masthead area (with image). Can be used for generic page content on site. (No template needed for a standard page without a masthead).
 *
 * @package Understrap
 */
